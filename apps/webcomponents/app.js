...
app.use("/tsparticles-demo-configs", express.static("./node_modules/tsparticles-demo-configs"));
app.use("/web-particles", express.static("./node_modules/@tsparticles/webcomponents/dist"));
